...
Revision ID: 03083f54e4f5
Revises: a926b4d3c3ad
Create Date: 2023-12-11 20:11:31.232128
...
revision = '03083f54e4f5'
down_revision = 'a926b4d3c3ad'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('MapSpots', schema=None) as batch_op:
        batch_op.alter_column('occupied',
