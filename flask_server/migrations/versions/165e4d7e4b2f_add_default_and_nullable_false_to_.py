"""add default and nullable=False to playerCode and playerStatus of the Users table

Revision ID: 165e4d7e4b2f
Revises: 1c9b6d2d3878
Create Date: 2023-11-11 18:10:16.269151
...
revision = '165e4d7e4b2f'
down_revision = '1c9b6d2d3878'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('Users', schema=None) as batch_op:
        batch_op.alter_column('playerStatus',
               existing_type=sa.INTEGER(),
               nullable=False)
        batch_op.create_unique_constraint(None, ['playerCode'])
