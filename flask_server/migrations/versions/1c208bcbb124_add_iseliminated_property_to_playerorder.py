"""add isEliminated property to PlayerOrder

Revision ID: 1c208bcbb124
Revises: 9b8690e27316
Create Date: 2023-11-14 00:07:17.243663
...
revision = '1c208bcbb124'
down_revision = '9b8690e27316'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('PlayerOrder', schema=None) as batch_op:
        batch_op.add_column(sa.Column('isEliminated', sa.Boolean(), nullable=True))
...
def downgrade():
    ...
    with op.batch_alter_table('PlayerOrder', schema=None) as batch_op:
        ...
        batch_op.drop_column('isEliminated')
