"""Changed to StartLocations

Revision ID: 1c9b6d2d3878
Revises: 8d722afa2e3d
Create Date: 2023-11-11 04:25:22.436851
...
revision = '1c9b6d2d3878'
down_revision = '8d722afa2e3d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('StartLocations',
    ...
    op.drop_table('CharacterLocations')
...
def downgrade():
    ...
    op.create_table('CharacterLocations',
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"CharacterLocations_id_seq"\'::regclass)'), autoincrement=True, nullable=False),
    sa.Column('characterId', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('locationId', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['characterId'], ['Characters.id'], name='CharacterLocations_characterId_fkey'),
    sa.ForeignKeyConstraint(['locationId'], ['Locations.id'], name='CharacterLocations_locationId_fkey'),
    sa.PrimaryKeyConstraint('id', name='CharacterLocations_pkey')
    )
    op.drop_table('StartLocations', schema='cs')
    # ### end Alembic commands ###
