"""added gameCode to Users table

Revision ID: 2105de95ddfb
Revises: 2c13a85cc450
Create Date: 2023-10-22 05:00:31.196528
...
revision = '2105de95ddfb'
down_revision = '2c13a85cc450'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('Users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('gameCode', sa.String(), nullable=True))
