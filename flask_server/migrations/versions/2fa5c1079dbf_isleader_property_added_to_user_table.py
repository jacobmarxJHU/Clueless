"""isLeader property added to User table

Revision ID: 2fa5c1079dbf
Revises: ae6f9992be5c
Create Date: 2023-11-12 01:59:14.131753
...
revision = '2fa5c1079dbf'
down_revision = 'ae6f9992be5c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('Users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('isLeader', sa.Boolean(), nullable=True))
