...
Revision ID: 42b93b0ea0a5
Revises: 1c208bcbb124
Create Date: 2023-12-11 18:47:34.244403
...
revision = '42b93b0ea0a5'
down_revision = '1c208bcbb124'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.drop_table('MapSpots', schema='cs')
    # ### end Alembic commands ###
