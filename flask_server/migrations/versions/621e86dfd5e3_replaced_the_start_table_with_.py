"""Replaced the start table with CharacterStart

Revision ID: 621e86dfd5e3
Revises: 1a7776fbe429
Create Date: 2023-11-11 04:17:07.290539
...
revision = '621e86dfd5e3'
down_revision = '1a7776fbe429'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text('nextval(\'"StartLocations_id_seq"\'::regclass)'), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['characterId'], ['Characters.id'], name='StartLocations_characterId_fkey'),
    sa.ForeignKeyConstraint(['locationId'], ['Locations.id'], name='StartLocations_locationId_fkey'),
    sa.PrimaryKeyConstraint('id', name='StartLocations_pkey')
    )
    # ### end Alembic commands ###
