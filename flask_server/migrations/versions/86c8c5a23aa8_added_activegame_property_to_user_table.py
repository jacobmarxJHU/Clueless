"""added activeGame property to User table

Revision ID: 86c8c5a23aa8
Revises: 2fa5c1079dbf
Create Date: 2023-11-12 02:57:49.090472
...
revision = '86c8c5a23aa8'
down_revision = '2fa5c1079dbf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('Users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('activeGame', sa.Integer(), nullable=True))
        batch_op.alter_column('playerCode',
               existing_type=sa.VARCHAR(length=6),
               nullable=False)
        batch_op.alter_column('isLeader',
...
def downgrade():
    ...
    with op.batch_alter_table('Users', schema=None) as batch_op:
        ...
        batch_op.alter_column('playerCode',
               existing_type=sa.VARCHAR(length=6),
               nullable=True)
        batch_op.drop_column('activeGame')
