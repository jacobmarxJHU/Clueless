"""Changed Solutions table schema to use card ids in lieu of weapon, location, character

Revision ID: 88b75fa23dc4
Revises: a6480f77cd6a
Create Date: 2023-11-13 01:57:13.341518
...
revision = '88b75fa23dc4'
down_revision = 'a6480f77cd6a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('Solutions', schema=None) as batch_op:
        batch_op.add_column(sa.Column('characterCard', sa.Integer(), nullable=False))
        batch_op.add_column(sa.Column('locationCard', sa.Integer(), nullable=False))
        batch_op.add_column(sa.Column('weaponCard', sa.Integer(), nullable=False))
...
def downgrade():
    ...
    with op.batch_alter_table('Solutions', schema=None) as batch_op:
        batch_op.add_column(sa.Column('characterId', sa.INTEGER(), autoincrement=False, nullable=False))
        batch_op.add_column(sa.Column('locationId', sa.INTEGER(), autoincrement=False, nullable=False))
        batch_op.add_column(sa.Column('weaponId', sa.INTEGER(), autoincrement=False, nullable=False))
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.drop_constraint(None, type_='foreignkey')
        ...
        batch_op.drop_column('weaponCard')
        batch_op.drop_column('locationCard')
        batch_op.drop_column('characterCard')
