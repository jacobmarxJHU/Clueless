"""CharacterLocations take 2

Revision ID: 8d722afa2e3d
Revises: 28b69276eef0
Create Date: 2023-11-11 04:19:25.116725
...
revision = '8d722afa2e3d'
down_revision = '28b69276eef0'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.drop_table('CharacterLocations', schema='cs')
    # ### end Alembic commands ###
