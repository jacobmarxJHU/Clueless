"""added unique prop to gameId in Solutions table

Revision ID: a6480f77cd6a
Revises: 86c8c5a23aa8
Create Date: 2023-11-13 01:35:27.338153
...
revision = 'a6480f77cd6a'
down_revision = '86c8c5a23aa8'
branch_labels = None
depends_on = None
