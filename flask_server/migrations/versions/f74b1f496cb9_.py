...
Revision ID: f74b1f496cb9
Revises: 5f0b33cb0003
Create Date: 2023-12-11 19:50:31.321925
...
revision = 'f74b1f496cb9'
down_revision = '5f0b33cb0003'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('MapSpots', schema=None) as batch_op:
        batch_op.add_column(sa.Column('occupied', sa.Boolean(), nullable=True))
